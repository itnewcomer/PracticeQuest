...
struct SetupView: View {
    ...
    private func setupSampleData() {
        ...
        let quests = ja ? [
            ...
            Quest(name: "英単語", icon: "🗣️", dailyCount: 1, starsPerComplete: 10, order: 3),
            Quest(name: "漢字練習", icon: "✏️", dailyCount: 1, starsPerComplete: 8, order: 4),
            Quest(name: "100ます計算", icon: "🧮", dailyCount: 1, isStopwatch: true, allowExtra: true, starsPerComplete: 5, order: 5),
        ] : [
            ...
            Quest(name: "Vocabulary", icon: "🗣️", dailyCount: 1, starsPerComplete: 10, order: 3),
            Quest(name: "Spelling", icon: "✏️", dailyCount: 1, starsPerComplete: 8, order: 4),
            Quest(name: "Math drill", icon: "🧮", dailyCount: 1, isStopwatch: true, allowExtra: true, starsPerComplete: 5, order: 5),
        ]
        quests.forEach { modelContext.insert($0) }

        let lessons = ja ? [
            Lesson(name: "そろばん", icon: "🧮", weekday: 1, startHour: 10),
            Lesson(name: "バレエ", icon: "🩰", weekday: 2, startHour: 16),
            Lesson(name: "水泳", icon: "🏊", weekday: 3, startHour: 16),
            Lesson(name: "英会話", icon: "🗣️", weekday: 4, startHour: 17),
            Lesson(name: "テコンドー", icon: "🥋", weekday: 5, startHour: 16),
            Lesson(name: "アート", icon: "🎨", weekday: 6, startHour: 15, startMinute: 30),
            Lesson(name: "ピアノ教室", icon: "🎹", weekday: 7, startHour: 10),
        ] : [
            Lesson(name: "Math club", icon: "🧮", weekday: 1, startHour: 10),
            Lesson(name: "Ballet", icon: "🩰", weekday: 2, startHour: 16),
            Lesson(name: "Swimming", icon: "🏊", weekday: 3, startHour: 16),
            Lesson(name: "English", icon: "🗣️", weekday: 4, startHour: 17),
            Lesson(name: "Taekwondo", icon: "🥋", weekday: 5, startHour: 16),
        ...
        let rewards = ja ? [
            ...
            Reward(name: "おかし", icon: "🍪", starCost: 100),
            Reward(name: "アイス", icon: "🍦", starCost: 500),
            Reward(name: "本", icon: "📕", starCost: 1500),
            ...
            Reward(name: "Snack", icon: "🍪", starCost: 100),
            Reward(name: "Ice cream", icon: "🍦", starCost: 500),
            Reward(name: "Book", icon: "📕", starCost: 1500),
