...
struct EditLessonView: View {
    ...
    var body: some View {
        Form {
            ...
            Stepper("\(lesson.startHour):\(String(format: "%02d", lesson.startMinute))", value: $lesson.startMinute, in: 0...45, step: 15)
...
struct EditRewardView: View {
    ...
    var body: some View {
        Form {
            ...
            Stepper("⭐ \(reward.starCost)", value: $reward.starCost, in: 5...1000, step: 5)
